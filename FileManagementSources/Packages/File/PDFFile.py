...
if not "D:/temp_perso/BankApp/BankAppSources/Packages/File" in sys.path:
    sys.path.insert(0, "D:/temp_perso/BankApp/BankAppSources/Packages/File")
...
# In[3]: Content of the file
    ...
    def GetLinesContent(self):
        ...
        .. note::
            displays the carriage return + line feed
        """
        return self.GetAllContent().splitlines()
    ...
    def GetLineContent(self, line):
        ...
        if line > 0 and line <= len(self.GetLinesContent()):
            return self.GetLinesContent()[line-1]
        else:
